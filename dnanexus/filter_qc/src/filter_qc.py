...
def main(input_bam=None, paired_end=None, samtools_params=None, input_JSON=None, debug=False): #
	...
	if not input_bam:
		logger.error('input_bam is required, explicitly or in input_JSON')
		raise Exception

	if paired_end == None:
		logger.error('paired_end is required, explicitly or in input_JSON')
		raise Exception
